...
class CubePrimitive : Primitive {
    ...
    override func draw(encoder: MTLRenderCommandEncoder) {
        ...
        encoder.drawIndexedPrimitives(.Triangle, indexCount: CubePrimitive.triangleList.count, indexType: .UInt16, indexBuffer: CubePrimitive.indexBuffer, indexBufferOffset: 0)
    }
